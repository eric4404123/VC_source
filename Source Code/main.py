...
if __name__ == '__main__':
    ...
    parser.add_argument('-hps_path',default='mixture_10_.json')
    parser.add_argument('-load_model_path')
    parser.add_argument('-dataset_path', default='mixture_10.h5')
    parser.add_argument('-index_path', default='mixture_10_index.json')
    parser.add_argument('-output_model_path', default='saveModel/')
